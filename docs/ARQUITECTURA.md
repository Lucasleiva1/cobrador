...
- **Google Apps Script** recibe ventas individuales por HTTPS con una clave privada, evita duplicados y regenera el CSV diario compartido en Google Drive. Autoriza inicialmente tres teléfonos y el límite puede ampliarse de forma privada.
